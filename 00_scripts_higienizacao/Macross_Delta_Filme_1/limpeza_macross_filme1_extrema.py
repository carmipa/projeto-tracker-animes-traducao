...
PASTA_ALVO = r"C:\animes\Macross-Delta-Filme-1"
...
def obter_pasta_alvo():
    ...
    while True:
        entrada = input(
            f"{Fore.CYAN}Pasta com as legendas .ass de Macross Delta Filme 1 (ENTER = {PASTA_ALVO}): {Style.RESET_ALL}"
        ).strip().strip('"').strip("'")
...
def varrer_tudo():
    ...
    print(Fore.MAGENTA + " MÁQUINA DE JUÍZO FINAL: MACROSS DELTA FILME 1 (V3 - MOTOR REGEX)")
    print(Fore.MAGENTA + "="*50)
