...
LORE_PROPRIO = {
    ...
    # Evita tradução literal errônea de "Garde/Gardes" (mechas do anime) para "Guarda/Guardas"
    "os guardas": "os Gardes",
    "o guarda": "o Garde",
    "um guarda": "um Garde",
    "guardas móveis": "Gardes",
    "guarda móvel": "Garde",
    "guarda ": "Garde ",
    "guardas ": "Gardes ",
    "Guarda ": "Garde ",
    ...
    # Partículas e propulsão
    "partícula Higgs": "partícula de Higgs",
    "partículas Higgs": "partículas de Higgs",
    "canhão Higgs": "canhão de Higgs",
    "canhão de partículas Higgs": "canhão de partículas de Higgs",
    "motor Higgs": "motor de Higgs",
    
    # Nomes e conceitos biológicos importantes
    "fotosintese": "fotossíntese",
    "fotosíntese": "fotossíntese",
    "Kabi": "Kabi",
    "Tsumugi": "Tsumugi",
    "Tanikaze": "Tanikaze",
    "Hoshijiro": "Hoshijiro",
...
def obter_pasta_alvo():
    ...
    while True:
        entrada = input(
            f"{Fore.CYAN}Pasta com as legendas .ass/.srt de Sidonia (ENTER = {PASTA_ALVO}): {Style.RESET_ALL}"
        ).strip().strip('"').strip("'")
...
def varrer_tudo():
    ...
    print(Fore.MAGENTA + " MÁQUINA DE JUÍZO FINAL: KNIGHTS OF SIDONIA (V3 - MOTOR REGEX)")
    print(Fore.MAGENTA + "="*50)
