...
PASTA_ALVO = r"E:\animes\GUILTY CROWN\1080p\legendas_eng"

# Termos de lore/marca: sempre normalizados para a grafia oficial,
# em QUALQUER caixa e posição na frase.
LORE_PROPRIO = {
    # Patente GHQ (achada em auditoria real)
    "Major Geral Yan": "Major-General Yan",
    "Tenente-General Yan": "Major-General Yan",
    "General de Brigada Yan": "Major-General Yan",
}
...
def obter_pasta_alvo():
    ...
    while True:
        entrada = input(
            f"{Fore.CYAN}Pasta com as legendas .ass de Guilty Crown (ENTER = {PASTA_ALVO}): {Style.RESET_ALL}"
        ).strip().strip('"').strip("'")
...
def varrer_tudo():
    ...
    print(Fore.MAGENTA + " MÁQUINA DE JUÍZO FINAL: GUILTY CROWN (V3 - MOTOR REGEX)")
    print(Fore.MAGENTA + "="*50)
