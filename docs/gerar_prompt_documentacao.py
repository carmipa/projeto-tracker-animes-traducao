...
--------------------------------------------------------------------------------
* FASE 00 (Inédita): '00_scripts_higienizacao/' (Higienização/normalização de termos/lore e reticências)
...
* FASE 05b (Antiga 4-B): '05b_tradutor_llm_mistral_nemo/' (Tradução especializada do Francês via Mistral Nemo)
* FASE 05c (Antiga 11): '05c_tradutor_llm_qwen2/' (Tradução do Chinês Simplificado via Qwen2.5)
* FASE 05c2 (Inédita): '05c_tradutor_llm_translategemma/' (Tradução e correção contextual via TranslateGemma)
* FASE 06 (Antiga 8): '06_cura_legendas/' (Cura offline ultra-rápida de tags corrompidas e strings 'TAG')
* FASE 07 (Antiga 9): '07_reparo_traducao/' (Módulo de reparo avulso batch=1 para consertar tags e [ERRO_TRADUCAO])
...
"""
    ...
    p2.append("1. REESCREVA o `/README.md` raiz adaptando as esteiras (A-I) e a tabela de fases para o padrão 00 a 12.")
    ...
    p3.append("Crie/reescreva os 16 arquivos Markdown de fase individuais detalhando quais scripts pertencem a cada uma:")
    p3.append("1. `docs/modulo-fase-00.md` (Fase 00: Higienização)")
    p3.append("2. `docs/modulo-fase-01.md` (Fase 01: Analisador)")
    p3.append("3. `docs/modulo-fase-02.md` (Fase 02: Extrator)")
    p3.append("4. `docs/modulo-fase-03.md` (Fase 03: Decodificador/Otimizador)")
    p3.append("5. `docs/modulo-fase-04.md` (Fase 04: Conversor)")
    p3.append("6. `docs/modulo-fase-05a.md` (Fase 05a: Gemma4)")
    p3.append("7. `docs/modulo-fase-05b.md` (Fase 05b: Mistral Nemo)")
    p3.append("8. `docs/modulo-fase-05c.md` (Fase 05c: Qwen2)")
    p3.append("9. `docs/modulo-fase-05c2.md` (Fase 05c2: TranslateGemma)")
    p3.append("10. `docs/modulo-fase-06.md` (Fase 06: Cura)")
    p3.append("11. `docs/modulo-fase-07.md` (Fase 07: Reparo)")
    p3.append("12. `docs/modulo-fase-08.md` (Fase 08: Sincronização)")
    p3.append("13. `docs/modulo-fase-09.md` (Fase 09: Injetor de Músicas)")
    p3.append("14. `docs/modulo-fase-10.md` (Fase 10: Auditoria e Revisão)")
    p3.append("15. `docs/modulo-fase-11.md` (Fase 11: Correção Legados)")
    p3.append("16. `docs/modulo-fase-12.md` (Fase 12: Remuxer)")
    p3.append("")
